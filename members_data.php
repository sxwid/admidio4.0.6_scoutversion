...
$orderCondition = '';
$orderColumns = array('no', 'member_this_orga', 'name', 'scout_name', 'gender', 'birthday', 'timestamp');
...
$mainSql = 'SELECT usr_id, CONCAT(last_name.usd_value,  \', \', first_name.usd_value) AS name,
					scout_name.usd_value AS scout_name, email.usd_value AS email, gender.usd_value AS gender,
...
$queryParamsMain = array(
    $gProfileFields->getProperty('LAST_NAME', 'usf_id'),
    $gProfileFields->getProperty('FIRST_NAME', 'usf_id'),
    $gProfileFields->getProperty('PFADINAME', 'usf_id'),
...
{
    $sql = 'SELECT usr_id, name, email, gender, birthday, scout_name, timestamp, member_this_orga, member_other_orga
